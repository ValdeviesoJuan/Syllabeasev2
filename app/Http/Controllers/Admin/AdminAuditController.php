...
class AdminAuditController extends Controller
{
    public function viewSyllabusAudit($syll_id)
    {
        ...
        return view('admin.syllabus.syllabusaudit', compact('syll_id', 'syllabusVersions', 'syll', 'bLeaders', 'bMembers', 'audits'));
    }
    public function viewTosAudit($tos_id)
    {
        ...
        return view('admin.tos.tosAudit', compact('tos_rows', 'tos', 'tos_id', 'bMembers', 'bLeaders', 'tosVersions', 'course_outcomes', 'audits'));
    }
}
