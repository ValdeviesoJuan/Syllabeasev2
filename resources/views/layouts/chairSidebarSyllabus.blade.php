            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        ...
                        <div class="flex items-center ms-3">
                            <div>
                                <button type="button" class="flex text-sm bg-yellow justify-center items-center rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user-chair">
                                    <span class="sr-only">Open user menu</span>
                                    <div class="w-8 h-8 rounded-full text-white text-sm flex justify-center items-center">
                            ...
                            <div class="w-[350px] z-50 hidden my-4 text-base shadow-xl px-4 py-2 list-none bg-white rounded dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user-chair">
                                <div class="flex flex-row">
                                    <!-- SyllabEase Logo -->
                                    <div>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-[65px] transition-transform -translate-x-full bg-blue border- border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-blue dark:bg-gray-800 ">
			...
			c-0.707,0-1.279,0.562-1.279,1.267C6.521,20.436,7.092,20.994,7.799,20.994z" />
                ...
                <li>
                    <a href="{{ route('chair.memo') }}"
                    class="{{ request()->route()->getName() == 'chair.memo' ? 'bg-blue4' : '' }} 
                            flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-blue4 dark:hover:bg-gray-700 group">
