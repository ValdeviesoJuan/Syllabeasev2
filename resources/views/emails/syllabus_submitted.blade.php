    ...
    <table width="80%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; max-width: 1000px; margin: auto;">
        ...
        <tr>
            <td style="padding: 20px;">
                <h3 style="margin-top: 0;">Syllabus Submitted</h3>

                <p style="font-size: 15px;">Dear Chairperson,</p>

                <p style="font-size: 15px;">The following syllabus has been submitted by the Bayanihan Leader for your review:</p>
                ...
                <p style="font-size: 15px;">You may now proceed to review it in the system.</p>
