    ...
    <div class="flex flex-col justify-center mb-[5px]">
        ...
        <div class="mt-8 space-y-6 mb-5">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-4">
                {{-- View Comments --}}
                <a href="{{ route('bayanihanleader.commentTos', $tos_id) }}"
                class="flex items-center gap-2 px-4 py-3 rounded-lg shadow transition transform hover:scale-105"
                ...
                style="background-color: #374151; color: #ffffff;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="24" width="24" viewBox="0 0 330 330">
        ...
        <div class="flex justify-end mx-auto w-[80%]">
            ...
            <div class="bg-blue px-2 py-1 hover:scale-105 m-1 text-white">
                <a href="{{ route('bayanihanleader.editTosRow', ['tos_id' => $tos_id]) }}">
