<div class="ml-[4%]">
    <div class="w-max px-8 mb-5 mt-2 pt-2 hover:scale-105 transition ease-in-out  py-2 text-white rounded ">
        <button wire:click="openComments"
    ...
    <div class=" flex flex-col w-full h-auto">
        <div class="z-10 absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
            <div class="shadow-lg bg-white fixed bg-opacity-90 w-[415px] min-h-[400px] rounded  font-sans bg-gradient-to-r from-[#FFF] to-[#dbeafe]">
