<div class=" text-left">
    <div class="flex flex-wrap items-center gap-3 mb-4">
        ...
        <select wire:model="filters.status" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[15%]" placeholder="Status">
