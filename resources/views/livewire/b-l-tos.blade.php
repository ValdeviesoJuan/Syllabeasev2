<div class=" text-left">
    <div class="flex flex-nowrap items-center gap-2 mb-4 w-full max-w-7xl mx-auto">
        <div class="relative w-[20%] min-w-0">
            <input
                wire:model.live="search"
                wire:keydown.enter="applyFilters"
                type="text"
                class="border focus:outline-none focus:border-blue border-black w-full rounded p-1 pr-10 min-w-0"
                placeholder="Search..."
            >
            <button
                type="button"
        ...
        <select wire:model="filters.course_year_level" class="border cursor-pointer focus:outline-none focus:border-blue rounded p-1 w-[12%] min-w-0" placeholder="Year level">
        ...
        <select wire:model="filters.course_semester" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[12%] min-w-0" placeholder="Semester">
        ...
        <select wire:model="filters.bg_school_year" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[11%] min-w-0" placeholder="School Year">
        ...
        <select wire:model="filters.tos_status" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[14%] min-w-0" placeholder="Status">
