<div class=" text-left">
    <div class="">
        ...
        <select wire:model="filters.course_year_level" class="border cursor-pointer focus:outline-none focus:border-blue rounded p-1 w-[11%] ml-2" placeholder="Year level">
        ...
        <select wire:model="filters.course_semester" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[11%] ml-2" placeholder="Semester">
            <option value="">Semester (All)</option>
            <option value="1st Semester">1st Semester</option>
            <option value="2nd Semester">2nd Semester</option>
            <option value="Mid Year">Mid Year</option>
        </select>
        <select wire:model="filters.tos_term" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[9%] ml-2" placeholder="Term">
        ...
        <select wire:model="filters.department_id" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[12%] ml-2" placeholder="Department">
            <option value="">Department (All)</option>
            @foreach($departments as $department)
            <option value="{{$department->department_id}}">{{$department->department_code}}</option>
            @endforeach
        </select>
        <select wire:model="filters.college_id" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[10%] ml-2" placeholder="College">
            <option value="">College (All)</option>
            @foreach($colleges as $college)
            <option value="{{$college->college_id}}">{{$college->college_code}}</option>
            @endforeach
        </select>
        <select wire:model="filters.tos_status" class="border focus:outline-none focus:border-blue cursor-pointer rounded p-1 w-[12%] ml-2" placeholder="Tos Status">
