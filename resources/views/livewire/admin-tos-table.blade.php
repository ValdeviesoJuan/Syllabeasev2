...
<div class="flex justify-between mb-4">
        ...
        <select wire:model="filters.department_id" class="border focus:outline-none focus:border-blue cursor-pointer rounded-lg p-1 w-[15%] ml-" placeholder="Department">
        ...
        <select wire:model="filters.college_id" class="border focus:outline-none focus:border-blue cursor-pointer rounded-lg p-1 w-[15%] ml-" placeholder="College">
