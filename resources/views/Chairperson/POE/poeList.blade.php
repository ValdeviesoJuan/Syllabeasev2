...
<body class="">
    ...
    <div>
        ...
        <div class="ml-10 mt-2 pt-2 w-max hover:scale-105 transition ease-in-out py-2 text-white rounded-lg pt-40 ">
        ...
        <div class="ml-10 mt-2 pt-2 w-max hover:scale-105 transition ease-in-out py-2 text-white rounded-lg ">
        ...
        <div class="flex ml-10 mt-2 pt-2 w-max hover:scale-105 transition ease-in-out  py-2 text-white rounded-lg ">
