                        ...
                        <div class="flex justify-between items-start w-full max-w-5xl">
                            ...
                            <table class="text-[10px] text-center border border-gray-400 w-40 mt-[25px]">
                                ...
                                <tbody>
                                    ...
                                    <!-- Data Row -->
                                    <tr>
                                        <td class="border border-gray-400 px-2 py-[2px]">{{ $reviewForm->version }}</td>
                                        <td class="border border-gray-400 px-2 py-[2px]">{{ \Carbon\Carbon::parse($reviewForm->effectivity_date)->format('m.d.y') }}</td>
