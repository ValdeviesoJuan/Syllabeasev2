...
<body class="font-thin ">
    <!-- Returned by Chair  -->
    @if($syll->chair_rejected_at != null && $syll->status == 'Returned by Chair')
    <div class="flex flex-col border-2 border-blue3 bg-white bg-opacity-75 w-[500px] rounded-lg h-[110px] mt-2 mx-auto">
        <div class="flex items-center justify-center">
            ...
            <div class="mt-1">
                <span class="font-semibold">Notice:</span> This syllabus version has was by the Department Chair for revisions. 
            </div>
        </div>
    ...
    <div class="flex flex-col border-2 border-blue3 bg-white bg-opacity-75 w-[500px] rounded-lg h-[110px] mt-2 mx-auto">
        <div class="flex items-center justify-center">
            ...
            <div class="mt-1">
                <span class="font-semibold">Notice:</span> This syllabus version was returned by the Dean for further revision.
            </div>
        </div>
    ...
    <div class="flex flex-col border-2 border-green3 bg-white bg-opacity-75 w-[500px] rounded-lg h-[70px] mt-2 mx-auto">
        <div class="flex items-center justify-center">
            ...
            <div class="mt-1">
                <span class="font-semibold">Notice:</span> This syllabus has already been <span class="font-semibold text-green">approved</span> by the Chair and the Dean.
            </div>
        </div>
    </div>
    @else 
